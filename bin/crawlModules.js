...
.end( wait(handleRes) );
request
.get('https://registry.npmjs.org/-/_view/byKeyword?startkey=["dpd-module"]&endkey=["dpd-module",{}]&group_level=3')
.end( wait(handleRes) );
request
...
wait.then(function(){
  ...
  var outputFile = __dirname + '/../public/javascripts/module-control.data.js';
