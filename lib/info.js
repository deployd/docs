...
Info.prototype.examples = function () {
  var children = this.children();
  var results = [];
  ...
  if(children) {
    children
      .filter(function (i) {
        return i.basename() === 'examples';
      })
      .forEach(function (i) {
        if(i.dir) {
          results = results.concat(i.children());
        }
      });
  }
...
Info.prototype.subReferences = function () {
  var result = [];
  
  this.children(true).forEach(function (c) {
    if(c.dir) {
