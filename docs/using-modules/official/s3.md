...
In your app's root directory, type `npm install dpd-s3` into the command line or [download the source](https://github.com/deployd/dpd-s3). This should create a `dpd-s3` directory in your app's `node_modules` directory.
